...
class DetailFacilityFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val tvTitleDetail :TextView = rootView.findViewById(R.id.textViewTitle)
        arguments?.let {
            val facility = it.getString(EXTRA_FACILITY)
            textViewDetail.text = getFacilityDetail(facility)
            tvTitleDetail.text = facility
            when (facility) {
    ...
    private fun getFacilityDetail(facility: String?): SpannableString {
        val detail = when (facility) {
            "Perpustakaan" -> "Perpustakaan Universitas Sebelas Maret (UNS) merupakan salah satu fasilitas penting yang ada di kampus tersebut. Berikut beberapa informasi tentang Perpustakaan UNS:\n" +
                    "\n" +
                    "Lokasi:\n" +
                    "Perpustakaan UNS terletak di Kampus Kentingan, Jl. Ir. Sutami 36A, Surakarta.\n" +
                    "\n" +
                    "Koleksi:\n" +
                    "Perpustakaan ini memiliki berbagai macam koleksi buku, jurnal, skripsi, tesis, disertasi, dan bahan pustaka lainnya. Koleksinya mencakup berbagai disiplin ilmu yang diajarkan di UNS.\n" +
                    "\n" +
                    "Fasilitas:\n" +
                    "Selain koleksi bahan pustaka, perpustakaan ini juga dilengkapi dengan fasilitas seperti ruang baca yang nyaman, ruang diskusi, ruang multimedia, dan akses komputer dengan internet. Tersedia juga layanan peminjaman dan pengembalian buku secara online.\n" +
                    "\n" +
                    "Layanan Digital:\n" +
                    "Perpustakaan UNS menyediakan layanan digital yang memungkinkan mahasiswa dan staf untuk mengakses berbagai sumber daya elektronik, termasuk e-books, e-journals, dan database akademik.\n" +
                    "\n" +
                    "Jam Operasional:\n" +
                    "Perpustakaan biasanya buka dari Senin hingga Jumat, dengan jam operasional mulai pagi hingga sore. Pada hari Sabtu, perpustakaan mungkin buka dengan jam operasional yang lebih singkat. Untuk informasi lebih detail mengenai jam operasional, disarankan untuk mengunjungi situs web resmi perpustakaan atau menghubungi langsung pihak perpustakaan.\n" +
                    "\n" +
                    "Keanggotaan:\n" +
                    "Mahasiswa, dosen, dan staf UNS otomatis menjadi anggota perpustakaan dan dapat memanfaatkan semua layanan yang disediakan. Pengguna dari luar UNS juga dapat mendaftar untuk menjadi anggota dengan mengikuti prosedur yang ditetapkan."
        ...
        val boldWords = listOf("Lokasi:", "Koleksi:", "Fasilitas:", "Kegiatan:", "Reservasi:", "Aksesibilitas:", "Lingkungan", "Stadion UNS:", "Gelanggang Olahraga (GOR):", "Lapangan Tenis:", "Lapangan Basket:", "Lapangan Voli:", "Layanan Digital:", "Jam Operasional:", "Keanggotaan:", "Telepon:", "Handphone/Whatsapp:", "Email:", "Instagram", "VISI :", "MISI :")

        for (word in boldWords) {
            var start = detail.indexOf(word)
            while (start >= 0) {
                val end = start + word.length
                spannable.setSpan(StyleSpan(Typeface.BOLD), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE)
                start = detail.indexOf(word, end)
            }
        }
